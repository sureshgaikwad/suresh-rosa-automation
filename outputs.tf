...
output "openshift_gitops_enabled" {
  ...
  value       = local.deploy_openshift_gitops
}

output "vote_application_enabled" {
  description = "Whether vote application is deployed via ArgoCD"
  value       = var.deploy_vote_application && local.deploy_openshift_gitops
}

output "gitops_repo_url" {
  description = "GitOps repository URL configured for ArgoCD"
  value       = var.deploy_vote_application && local.deploy_openshift_gitops ? var.gitops_repo_url : null
}

output "argocd_server_url" {
  description = "ArgoCD server URL (available when vote application is deployed)"
  value       = var.deploy_vote_application && local.deploy_openshift_gitops ? "https://openshift-gitops-server-openshift-gitops.apps.${module.rosa_cluster_hcp.cluster_domain}" : null
}
...
output "nvidia_gpu_operator_gitops_enabled" {
  ...
  value       = local.deploy_nvidia_gpu_operator && local.deploy_openshift_gitops
}
...
output "openshift_lightspeed_enabled" {
  ...
  value       = local.deploy_openshift_lightspeed && local.deploy_openshift_gitops
}

output "authorino_operator_enabled" {
  description = "Whether Authorino operator is deployed via ArgoCD using GitOps catalog"
  value       = var.deploy_authorino_operator && local.deploy_openshift_gitops
}

output "ai_model_enabled" {
  description = "Whether AI model is deployed via ArgoCD"
  value       = var.deploy_ai_model && local.deploy_openshift_gitops
}
